...
organization = "rhd1vo" # Organization ID
deviceType = "ArduinoUNO"   # Device type
deviceId = "PNT2022TMID49676"    # Device ID
...
root.title('Gas Leakage Monitoring And Alerting System for Industries (PNT2022TMID49676)')
